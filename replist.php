 ...
 ?>
    ...
    .table td::before{
        ...
        text-align: left;
                                    ...
                                    <?php 
                                    $mysqli=NEW MySQLi('localhost','root','','courseware');
                                    $pp=3;
                                    ...
                                    $resultset=$mysqli->query("SELECT * FROM tr WHERE AccountID=(SELECT AccountID FROM accounts WHERE Email='".$_SESSION['login']."')");
...
<?php
 ...
 $resultset=$mysqli->query("SELECT * FROM tr  LIMIT $start,$pp");
$cnt=1;
...
?>
   ...
   <img src="yachtphoto/<?php echo $p;?>" width="400" height="400">
   <?php } ?></td>
...
<button class="btn btn-primary"><i class="fa fa-edit "></i> Edit Transaction</button> </a>    
 &nbsp;&nbsp;                                  
<a href="manage-students.php?id=<?php echo $row['StudentRegno']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">
                                            <button class="btn btn-danger">Cancel Repair</button>
                                              <br>
                                        <br>
                                             <br>
                                        <br>
