...
{
$sql=mysqli_query($con,"SELECT password FROM  accounts where password='".md5($_POST['cpass'])."' && Email='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update accounts set password='".md5($_POST['newpass'])."', updationDate='$currentTime' where Email='".$_SESSION['login']."'");
